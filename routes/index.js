...
router.get('/', (req, res) => {
    res.json({
        ...
        "replace an order with put": "api/v1/orders/replace/id",
        ...
        "replace a department by id with put": "api/v1/departments/replace/id",
        "computers": "api/v1/computers",
        "computer by id": "api/v1/computers/:id",
        "post new computer": "api/v1/computers/new",
        "replace a computer by id with put": "api/v1/computers/replace/id",
        ...
        "replace payment type by id with put": "api/v1/payment-types/replace/id",
        ...
        "replace a product by id with put": "api/products/replace/id",
        ...
        "replace a product type with put": "/api/v1/product-types/replace/id",
        ...
        "replace a training with put": "api/v1/training/replace/id",
